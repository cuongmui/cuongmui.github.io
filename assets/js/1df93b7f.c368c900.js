      ...
      const o = (e) => {
        ...
        return (
          (0, n.useEffect)(() => {
            ...
            return () => {
              for (; t.current?.firstChild; )
                t.current.removeChild(t.current.firstChild);
            };
          }, []),
          (0, r.jsx)("div", { ref: t, ...e })
        );
      ...
      const l = [
        {
          ...
          description: (0, c.jsxs)(c.Fragment, {
            children: [
              (0, c.jsx)("p", {
                children:
                  "Chia sẻ thông tin về lĩnh vực dược phẩm Y Tế, hỗ trợ giải đáp thắc mắc trong quá trình sử dụng thuốc!",
              }),
        ...
        return (0, c.jsx)("header", {
          ...
          children: (0, c.jsxs)("div", {
            ...
            children: [
              ...
              (0, c.jsxs)("div", {
                className: "my-2",
                children: ["Chúc bạn ngày tốt lành: ", t],
              }),
              (0, c.jsx)("div", {
