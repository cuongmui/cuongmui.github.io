  ...
  [7918],
  {
        ...
        x = i.forwardRef((e, n) => {
          ...
          return (0, f.jsx)(p.Z, {
            ...
            children: (e, n) =>
              i.cloneElement(o, {
                ...n,
                className: s()("fade", t, o.props.className, b[e], r[e]),
              }),
          });
        });
      (x.propTypes = m), (x.displayName = "Fade");
      const g = x;
    },
    89542: (e, n, t) => {
      "use strict";
    ...
    11660: (e, n, t) => {
      ...
      const g = (e) => {
          ...
          return (0, x.jsx)("div", {
            ref: s,
            children: (0, x.jsx)(a.i5, { className: n, onClick: c }),
          });
        },
        h = {
        ...
        v = (e) =>
          (0, x.jsx)("div", {
            className: (0, s.Z)("alert alert-info p-2", h.editorInfoMessage),
            ...e,
          });
      v.displayName = "EditorInfoMessage";
      const y = v;
      function j(e) {
        let { children: n } = e;
        return (0, x.jsx)("div", {
          className: (0, s.Z)(h.playgroundHeader),
          children: n,
        });
      }
      function N() {
        return (0, x.jsx)("div", { children: "Loading..." });
      }
      function C(e) {
        let { className: n } = e;
        return (0, x.jsxs)(x.Fragment, {
          children: [
            ...
            (0, x.jsx)("div", {
              className: h.playgroundPreview,
              children: (0, x.jsx)(c.Z, {
                fallback: (0, x.jsx)(N, {}),
                children: () =>
                  (0, x.jsxs)(x.Fragment, {
                    children: [
                      (0, x.jsx)(g, { className: n }),
                      (0, x.jsx)(a.IF, {}),
                    ],
                  }),
              }),
      ...
      function w() {
        const { code: e } = (0, o.useContext)(a.L2),
          ...
          f = (0, o.useRef)(!1),
          m = (0, o.useRef)(null);
        null === m.current && (m.current = "described-by-" + ++E);
        const b = m.current,
          g = (0, o.useCallback)(
            (e) => {
              l
        ...
        return (0, x.jsxs)("div", {
          ...
          children: [
            (0, x.jsx)(
              a.uz,
              {
                className: h.playgroundEditor,
                onFocus: v,
                onBlur: j,
                onKeyDown: g,
                onMouseDown: N,
                "aria-describedby": w ? b : null,
                ...C,
              },
              String(n)
            ),
            (0, x.jsxs)("div", {
              className: (0, s.Z)(h.editorToolbar),
              children: [
                w &&
                  (0, x.jsx)(y, {
                    id: b,
      ...
      function P(e) {
        ...
        return (0, x.jsx)("div", {
          className: h.playgroundContainer,
          children: (0, x.jsx)(a.nu, {
            code: n.replace(/\n$/, ""),
            noInline: p,
            transformCode: t ?? ((e) => `${e};`),
            theme: u,
            ...
            children:
              "top" === c
                ? (0, x.jsxs)(x.Fragment, {
                    children: [
                      (0, x.jsx)(C, { className: (0, s.Z)("bs-example", o) }),
                      (0, x.jsx)(T, {}),
                    ],
                  })
                : (0, x.jsxs)(x.Fragment, {
    ...
    65358: (e, n, t) => {
      ...
      t.r(o),
        t.d(o, {
          ...
          ToastHeader: () => Va,
          ToggleButton: () => si,
          ToggleButtonGroup: () => ii,
          Tooltip: () => br,
          useAccordionButton: () => A,
        });
      var s = t(67294),
        r = t.t(s, 2),
        a = t(90005),
      ...
      const N = {
        ...
        E = s.forwardRef((e, n) => {
          let {
            ...
            unmountOnExit: C = !1,
            appear: E = !1,
            getDimensionValue: w = j,
            ...T
          } = e;
          const P = "function" == typeof u ? u() : u,
            O = (0, s.useMemo)(
              () =>
                x((e) => {
                  e.style[P] = "0";
      ...
      P.displayName = "AccordionContext";
      const O = P,
        k = {
          as: c().elementType,
        ...
        R = s.forwardRef((e, n) => {
          ...
          const { activeEventKey: d } = (0, s.useContext)(O);
          return (
            ...
            (0, v.jsx)(w, {
              ...
              ...c,
              className: i()(r, o),
              children: (0, v.jsx)(t, { children: s.Children.only(a) }),
            })
          );
        });
      (R.propTypes = k), (R.displayName = "AccordionCollapse");
      const Z = R,
      ...
      const I = $,
        ...
        S = s.forwardRef((e, n) => {
          ...
          const { eventKey: b } = (0, s.useContext)(I);
          return (0, v.jsx)(Z, {
            eventKey: b,
            onEnter: a,
            onEntering: l,
            ...
            onExiting: p,
            onExited: f,
            children: (0, v.jsx)(t, { ref: n, ...m, className: i()(r, o) }),
          });
        });
      (S.propTypes = F), (S.displayName = "AccordionBody");
      const B = S,
        M = { as: c().elementType, bsPrefix: c().string, onClick: c().func };
      function A(e, n) {
        const {
          activeEventKey: t,
          onSelect: o,
      ...
      const L = s.forwardRef((e, n) => {
        ...
        const { eventKey: c } = (0, s.useContext)(I),
          d = A(c, a),
          { activeEventKey: p } = (0, s.useContext)(O);
        return (
          ...
          (0, v.jsx)(t, {
            ...
            className: i()(r, o, !T(p, c) && "collapsed"),
          })
        );
      });
      (L.propTypes = M), (L.displayName = "AccordionButton");
      const H = L,
        D = { as: c().elementType, bsPrefix: c().string, onClick: c().func },
        z = s.forwardRef((e, n) => {
          let {
            as: t = "h2",
            "aria-controls": o,
      ...
      (z.propTypes = D), (z.displayName = "AccordionHeader");
      const K = z,
        _ = {
          as: c().elementType,
          bsPrefix: c().string,
        ...
        V = s.forwardRef((e, n) => {
          ...
          return (0, v.jsx)(I.Provider, {
            value: c,
            children: (0, v.jsx)(t, { ref: n, ...l, className: i()(r, o) }),
          });
        });
      (V.propTypes = _), (V.displayName = "AccordionItem");
      const G = V,
        q = {
          as: c().elementType,
          bsPrefix: c().string,
      ...
      (U.displayName = "Accordion"), (U.propTypes = q);
      ...
      (te.displayName = "Badge"), (te.propTypes = ne);
      const oe = te,
        se = {
          bsPrefix: c().string,
          active: c().bool,
      ...
      (re.displayName = "BreadcrumbItem"), (re.propTypes = se);
      const ae = re,
        ie = {
          bsPrefix: c().string,
          label: c().string,
      ...
      (le.displayName = "Breadcrumb"), (le.propTypes = ie);
      const ce = Object.assign(le, { Item: ae });
      var de = t(6120);
      const ue = {
          bsPrefix: c().string,
          variant: c().string,
        ...
        pe = s.forwardRef((e, n) => {
          ...
          const p = (0, u.vE)(o, "btn"),
            [f, { tagName: m }] = (0, de.FT)({ tagName: t, disabled: l, ...d }),
            b = m;
          return (0, v.jsx)(b, {
            ...f,
            ...d,
      ...
      (pe.displayName = "Button"), (pe.propTypes = ue);
      const fe = pe,
        me = {
          bsPrefix: c().string,
          size: c().string,
      ...
      (be.displayName = "ButtonGroup"), (be.propTypes = me);
      const xe = be,
        ge = { bsPrefix: c().string, role: c().string },
        he = s.forwardRef((e, n) => {
      ...
      (he.displayName = "ButtonToolbar"), (he.propTypes = ge);
      const ve = he,
        ye = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
          return (
            (o = (0, u.vE)(o, "card-body")),
            (0, v.jsx)(s, { ref: n, className: i()(t, o), ...r })
          );
        });
      ...
      Ee.displayName = "CardHeaderContext";
      const we = Ee,
        Te = { bsPrefix: c().string, as: c().elementType },
        Pe = s.forwardRef((e, n) => {
          ...
          return (0, v.jsx)(we.Provider, {
            value: c,
            children: (0, v.jsx)(r, { ref: n, ...a, className: i()(o, l) }),
          });
        });
      (Pe.displayName = "CardHeader"), (Pe.propTypes = Te);
      const Oe = Pe,
        ke = {
          bsPrefix: c().string,
      ...
      (Re.displayName = "CardImg"), (Re.propTypes = ke);
      const Ze = Re,
        $e = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
          return (
      ...
      Fe.displayName = "CardLink";
      const Se = Fe;
      var Be = t(54305);
      const Me = (0, Be.Z)("h6"),
        Ae = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = Me, ...r } = e;
          return (
            (o = (0, u.vE)(o, "card-subtitle")),
            (0, v.jsx)(s, { ref: n, className: i()(t, o), ...r })
          );
        });
      Ae.displayName = "CardSubtitle";
      const Le = Ae,
        He = s.forwardRef((e, n) => {
      ...
      He.displayName = "CardText";
      const De = He,
        ze = (0, Be.Z)("h5"),
        Ke = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = ze, ...r } = e;
          return (
      ...
      const _e = Ke,
        ...
        Ge = s.forwardRef((e, n) => {
          ...
          return (0, v.jsx)(d, {
            ...
            children: l ? (0, v.jsx)(je, { children: c }) : c,
          });
        });
      (Ge.displayName = "Card"), (Ge.propTypes = Ve);
      ...
      Ue.displayName = "CardGroup";
      const We = Ue;
      var Xe = t(4708),
        Ye = t(70388),
        Je = t(6153),
        Qe = t(59634);
      const en = s.forwardRef((e, n) => {
        let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
        return (
      ...
      en.displayName = "CarouselCaption";
      const nn = en,
        tn = {
          as: c().elementType,
          bsPrefix: c().string,
        ...
        on = s.forwardRef((e, n) => {
          ...
          return (0, v.jsx)(t, { ref: n, ...r, className: a });
        });
      (on.displayName = "CarouselItem"), (on.propTypes = tn);
      const sn = on;
      function rn(e, n) {
        let t = 0;
      ...
      const cn = s.forwardRef((e, n) => {
        ...
        const {
            ...
            onTouchMove: $,
            onTouchEnd: I,
            prevIcon: F = (0, v.jsx)("span", {
              "aria-hidden": "true",
              className: "carousel-control-prev-icon",
            }),
            prevLabel: S = "Previous",
            nextIcon: B = (0, v.jsx)("span", {
              "aria-hidden": "true",
          ...
          K = (0, u.SC)(),
          _ = (0, s.useRef)(null),
          [V, G] = (0, s.useState)("next"),
          [q, U] = (0, s.useState)(!1),
          [W, X] = (0, s.useState)(!1),
          [Y, J] = (0, s.useState)(x || 0);
        (0, s.useEffect)(() => {
          W ||
            x === Y ||
            (_.current ? G(_.current) : G((x || 0) > Y ? "next" : "prev"),
            l && X(!0),
            J(x || 0));
        }, [x, W, Y, l]),
          (0, s.useEffect)(() => {
                ...
                children: rn(H, (e, n) =>
                  (0, v.jsx)(
                    "button",
                    {
                      type: "button",
                      "data-bs-target": "",
                      "aria-label": m?.length ? m[n] : `Slide ${n + 1}`,
      ...
      (cn.displayName = "Carousel"), (cn.propTypes = ln);
      const dn = Object.assign(cn, { Caption: nn, Item: sn });
      var un = t(12752);
      const pn = c().oneOfType([
          c().bool,
          c().number,
          c().string,
          c().oneOf(["auto"]),
        ]),
        fn = c().oneOfType([c().number, c().string]),
        mn = c().oneOfType([
          pn,
          c().shape({ size: pn, order: fn, offset: fn }),
        ]),
        bn = {
          bsPrefix: c().string,
          as: c().elementType,
      ...
      (gn.displayName = "Col"), (gn.propTypes = bn);
      const hn = gn,
        vn = {
          bsPrefix: c().string,
      ...
      (yn.displayName = "Container"), (yn.propTypes = vn);
      const jn = yn;
      var Nn = t(29508);
      const Cn = s.createContext({});
      Cn.displayName = "DropdownContext";
      const En = Cn,
        wn = s.forwardRef((e, n) => {
          let {
            className: t,
          ...
          return (
            ...
            (0, v.jsx)(s, { ref: n, className: i()(t, o), role: r, ...a })
          );
        });
      ...
      (Zn.displayName = "DropdownItem"), (Zn.propTypes = Rn);
      const $n = Zn,
        In = s.forwardRef((e, n) => {
      ...
      In.displayName = "DropdownItemText";
      const Fn = In;
      var Sn = t(78200),
        Bn = t(35300),
        Mn = t(59809),
      ...
      Hn.displayName = "InputGroupContext";
      const Dn = Hn,
        zn = s.createContext(null);
      ...
      const Yn = s.forwardRef((e, n) => {
        let {
          ...
          x = !1;
        const g = (0, s.useContext)(Kn),
          h = (0, u.vE)(t, "dropdown-menu"),
          { align: y, drop: j, isRTL: N } = (0, s.useContext)(En);
        r = r || y;
        const C = (0, s.useContext)(Dn),
          E = [];
        if (r)
          if ("object" == typeof r) {
            ...
            if (
              ...
              const n = e[0],
                t = r[n];
              (x = "start" === t), E.push(`${h}-${n}-${t}`);
            }
          } else "end" === r && (x = !0);
        const w = Xn(x, j, N),
          [T, { hasShown: P, popper: O, show: k, toggle: R }] = (0, Sn.d)({
            flip: l,
            rootCloseEvent: a,
            show: c,
      ...
      (Yn.displayName = "DropdownMenu"), (Yn.propTypes = Wn);
      const Jn = Yn;
      var Qn = t(65779),
        et = t(81410);
      const nt = {
        ...
        tt = s.forwardRef((e, n) => {
          ...
          const d = (0, u.vE)(t, "dropdown-toggle"),
            p = (0, s.useContext)(Qn.Z);
          void 0 !== a && (c.bsPrefix = a);
          const [f] = (0, et.Jr)();
          return (
            (f.ref = (0, Mn.Z)(f.ref, Gn(n))),
            (0, v.jsx)(l, {
      ...
      (tt.displayName = "DropdownToggle"), (tt.propTypes = nt);
      const ot = tt,
        st = {
          bsPrefix: c().string,
          drop: c().oneOf([
      ...
      (rt.displayName = "Dropdown"), (rt.propTypes = st);
      const at = Object.assign(rt, {
          Toggle: ot,
          Menu: Jn,
          Item: $n,
          ItemText: Fn,
      ...
      (lt.displayName = "DropdownButton"), (lt.propTypes = it);
      const ct = lt;
      var dt = t(33285);
      const ut = {
          bsPrefix: c().string,
      ...
      (pt.displayName = "Image"), (pt.propTypes = ut);
      const ft = pt,
        mt = s.forwardRef((e, n) => {
      ...
      (mt.displayName = "FigureImage"), (mt.propTypes = ut);
      const bt = mt,
        xt = s.forwardRef((e, n) => {
      ...
      ht.displayName = "Figure";
      const vt = Object.assign(ht, { Image: bt, Caption: gt }),
        yt = { type: c().string, tooltip: c().bool, as: c().elementType },
        jt = s.forwardRef((e, n) => {
          let {
            as: t = "div",
            className: o,
      ...
      (jt.displayName = "Feedback"), (jt.propTypes = yt);
      const Nt = jt,
        Ct = s.createContext({}),
        Et = {
          bsPrefix: c().string,
        ...
        wt = s.forwardRef((e, n) => {
          ...
          const { controlId: f } = (0, s.useContext)(Ct);
          return (
      ...
      (wt.displayName = "FormCheckInput"), (wt.propTypes = Et);
      const Tt = wt,
        Pt = { bsPrefix: c().string, htmlFor: c().string },
        Ot = s.forwardRef((e, n) => {
          let { bsPrefix: t, className: o, htmlFor: r, ...a } = e;
          const { controlId: l } = (0, s.useContext)(Ct);
          return (
      ...
      (Ot.displayName = "FormCheckLabel"), (Ot.propTypes = Pt);
      const kt = Ot,
        Rt = {
          bsPrefix: c().string,
        ...
        Zt = s.forwardRef((e, n) => {
          ...
          const { controlId: w } = (0, s.useContext)(Ct),
            ...
            children: (0, v.jsx)("div", {
              ...
              children:
                ...
                (0, v.jsxs)(v.Fragment, {
                  children: [
                    O,
                    P && (0, v.jsx)(kt, { title: h, children: j }),
                    m && (0, v.jsx)(Nt, { type: b, tooltip: f, children: m }),
                  ],
                }),
            }),
          });
        });
      (Zt.displayName = "FormCheck"), (Zt.propTypes = Rt);
      const $t = Object.assign(Zt, { Input: Tt, Label: kt }),
        It = {
          bsPrefix: c().string,
          _ref: c().any,
          size: c().string,
        ...
        Ft = s.forwardRef((e, n) => {
          ...
          const { controlId: g } = (0, s.useContext)(Ct);
          return (
      ...
      (Ft.displayName = "FormControl"), (Ft.propTypes = It);
      const St = Object.assign(Ft, { Feedback: Nt }),
        Bt = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
          return (
      ...
      Bt.displayName = "FormFloating";
      const Mt = Bt,
        At = { as: c().elementType, controlId: c().string, _ref: c().any },
        Lt = s.forwardRef((e, n) => {
          let { controlId: t, as: o = "div", ...r } = e;
          const a = (0, s.useMemo)(() => ({ controlId: t }), [t]);
          return (0, v.jsx)(Ct.Provider, {
            value: a,
            children: (0, v.jsx)(o, { ...r, ref: n }),
          });
        });
      (Lt.displayName = "FormGroup"), (Lt.propTypes = At);
      const Ht = Lt,
        Dt = {
          bsPrefix: c().string,
          htmlFor: c().string,
        ...
        zt = s.forwardRef((e, n) => {
          ...
          const { controlId: p } = (0, s.useContext)(Ct);
          ...
          return (
            ...
            r
              ...
              : (0, v.jsx)(t, { ref: n, className: m, htmlFor: c, ...d })
          );
        });
      (zt.displayName = "FormLabel"), (zt.propTypes = Dt);
      const Kt = zt,
        _t = {
          bsPrefix: c().string,
          disabled: c().bool,
      ...
      (Vt.displayName = "FormRange"), (Vt.propTypes = _t);
      const Gt = Vt,
        qt = {
          bsPrefix: c().string,
          size: c().string,
      ...
      (Ut.displayName = "FormSelect"), (Ut.propTypes = qt);
      const Wt = Ut,
        Xt = {
          bsPrefix: c().string,
          _ref: c().any,
      ...
      (Yt.displayName = "FormText"), (Yt.propTypes = Xt);
      const Jt = Yt,
        Qt = s.forwardRef((e, n) =>
          (0, v.jsx)($t, { ...e, ref: n, type: "switch" })
        );
      Qt.displayName = "Switch";
      const eo = Object.assign(Qt, { Input: $t.Input, Label: $t.Label }),
        no = {
          as: c().elementType,
          controlId: c().string,
        ...
        to = s.forwardRef((e, n) => {
          ...
          return (
            ...
            (0, v.jsxs)(Ht, {
              ...
              controlId: r,
              ...l,
              children: [s, (0, v.jsx)("label", { htmlFor: r, children: a })],
            })
          );
        });
      (to.displayName = "FloatingLabel"), (to.propTypes = no);
      const oo = to,
        so = { _ref: c().any, validated: c().bool, as: c().elementType },
        ro = s.forwardRef((e, n) => {
      ...
      (ro.displayName = "Form"), (ro.propTypes = so);
      const ao = Object.assign(ro, {
          Group: Ht,
          Control: St,
          Floating: Mt,
          Check: $t,
      ...
      (uo.propTypes = co), (uo.displayName = "InputGroup");
      const po = Object.assign(uo, {
        Text: lo,
        Radio: (e) =>
          (0, v.jsx)(lo, { children: (0, v.jsx)(Tt, { type: "radio", ...e }) }),
        Checkbox: (e) =>
          (0, v.jsx)(lo, {
            children: (0, v.jsx)(Tt, { type: "checkbox", ...e }),
          }),
      });
      var fo = t(89912),
        mo = t(83691),
      ...
      (go.propTypes = xo), (go.displayName = "ListGroupItem");
      const ho = go,
        vo = {
          bsPrefix: c().string,
      ...
      (yo.propTypes = vo), (yo.displayName = "ListGroup");
      const jo = Object.assign(yo, { Item: ho });
      var No = t(45072),
        Co = t(93335),
        Eo = t(26783),
        wo = t(56978),
      ...
      class Ao extends Fo.Z {
        ...
        setContainerStyle(e) {
          ...
          if (((0, Zo.Z)(n, "modal-open"), !e.scrollBarWidth)) return;
        ...
        removeContainerStyle(e) {
          ...
          const t = this.isRTL ? "paddingLeft" : "paddingRight",
            o = this.isRTL ? "marginLeft" : "marginRight";
          (0, $o.Z)(n, So).forEach((e) => this.restore(t, e)),
            (0, $o.Z)(n, Bo).forEach((e) => this.restore(o, e)),
            (0, $o.Z)(n, Mo).forEach((e) => this.restore(o, e));
        }
      }
      let Lo;
      function Ho(e) {
        return Lo || (Lo = new Ao(e)), Lo;
      }
      const Do = Ao,
        zo = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
      ...
      zo.displayName = "ModalBody";
      const Ko = zo,
        _o = s.createContext({ onHide() {} }),
        Vo = {
          bsPrefix: c().string,
      ...
      (Go.displayName = "ModalDialog"), (Go.propTypes = Vo);
      const qo = Go,
        Uo = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
          return (
        ...
        Yo = s.forwardRef((e, n) => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              i,
              r &&
                (0, v.jsx)(un.Z, { "aria-label": t, variant: o, onClick: d }),
            ],
          });
        });
      Yo.propTypes = Xo;
      ...
      (es.displayName = "ModalHeader"), (es.propTypes = Qo);
      const ns = es,
        ts = (0, Be.Z)("h4"),
        os = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = ts, ...r } = e;
          return (
            (o = (0, u.vE)(o, "modal-title")),
            (0, v.jsx)(s, { ref: n, className: i()(t, o), ...r })
          );
        });
      os.displayName = "ModalTitle";
      const ss = os,
        rs = {
          bsPrefix: c().string,
          size: c().string,
      ...
      function as(e) {
        return (0, v.jsx)(dt.Z, { ...e, timeout: null });
      }
      function is(e) {
        return (0, v.jsx)(dt.Z, { ...e, timeout: null });
      }
      const ls = s.forwardRef((e, n) => {
        let {
          bsPrefix: t,
          className: o,
          style: r,
        ...
        function J(e) {
          ...
          const n = Y().getScrollbarWidth() > 0,
            t = e.scrollHeight > (0, Eo.Z)(e).documentElement.clientHeight;
          L({
            paddingRight: n && !t ? (0, To.Z)() : void 0,
            paddingLeft: !n && t ? (0, To.Z)() : void 0,
          });
        }
        const Q = (0, Xe.Z)(() => {
          V && J(V.dialog);
        ...
        (0, Oo.Z)(() => {
          (0, wo.Z)(window, "resize", Q), _.current?.();
        });
        const ee = () => {
            z.current = !0;
          },
          ne = (e) => {
            z.current && V && e.target === V.dialog && (K.current = !0),
              (z.current = !1);
          },
          te = () => {
            D(!0),
              (_.current = (0, ko.Z)(V.dialog, () => {
                D(!1);
              }));
          },
          oe = (e) => {
          ...
          re = { ...r, ...A };
        re.display = "block";
        return (0, v.jsx)(_o.Provider, {
          value: X,
          children: (0, v.jsx)(Ro.Z, {
            show: x,
            ref: q,
            backdrop: h,
            container: E,
            ...
            restoreFocusOptions: O,
            onEscapeKeyDown: (e) => {
              y ? j?.(e) : (e.preventDefault(), "static" === h && te());
            },
            onShow: N,
            onHide: C,
            onEnter: (e, n) => {
            ...
            onExited: (e) => {
              e && (e.style.display = ""),
                F?.(e),
                (0, wo.Z)(window, "resize", Q);
            },
            manager: Y(),
            transition: g ? as : void 0,
            backdropTransition: g ? is : void 0,
            renderBackdrop: se,
            renderDialog: (e) =>
              (0, v.jsx)("div", {
                role: "dialog",
      ...
      (ls.displayName = "Modal"), (ls.propTypes = rs);
      const cs = Object.assign(ls, {
        Body: Ko,
        Header: ns,
        Title: ss,
        Footer: Wo,
      ...
      const bs = ms,
        ...
        gs = s.forwardRef((e, n) => {
          ...
          let g,
            h,
            y = !1;
          const j = (0, s.useContext)(Kn),
            N = (0, s.useContext)(we);
          return (
            j
              ? ((g = j.bsPrefix), (y = null == c || c))
              : N && ({ cardHeaderBsPrefix: h } = N),
            (0, v.jsx)(fo.Z, {
              as: t,
              ref: n,
              activeKey: m,
      ...
      const hs = Object.assign(gs, { Item: ps, Link: bs }),
        ...
        ys = s.forwardRef((e, n) => {
          ...
          return (0, v.jsx)(a, { ...r, ref: n, className: i()(o, t) });
        });
      ...
      const js = ys,
        ...
        Cs = s.forwardRef((e, n) => {
          ...
          const a = (0, s.useContext)(Kn);
          return (0, v.jsx)(w, {
            in: !(!a || !a.expanded),
            ...r,
            children: (0, v.jsx)("div", { ref: n, className: o, children: t }),
          });
        });
      ...
      const Es = Cs,
        ...
        Ts = s.forwardRef((e, n) => {
          ...
          const { onToggle: p, expanded: f } = (0, s.useContext)(Kn) || {},
            m = (0, Xe.Z)((e) => {
              c && c(e), p && p();
            });
          return (
            ...
            (0, v.jsx)(l, {
              ...
              children: r || (0, v.jsx)("span", { className: `${t}-icon` }),
            })
          );
        });
      ...
      (Is.propTypes = Zs), (Is.displayName = "OffcanvasToggling");
      const Fs = Is,
        Ss = {
          bsPrefix: c().string,
          closeLabel: c().string,
      ...
      const _s = s.forwardRef((e, n) => {
        ...
        const L = (0, s.useMemo)(() => ({ onHide: M }), [M]);
        const H = (0, s.useCallback)(
            (e) =>
              (0, v.jsx)("div", { ...e, className: i()(`${t}-backdrop`, R) }),
            [R, t]
          ),
          D = (e) =>
            (0, v.jsx)("div", {
            ...
            (0, v.jsx)(_o.Provider, {
              ...
              children: (0, v.jsx)(Ro.Z, {
                ...
                manager:
                  ...
                  (m
                    ? (F.current ||
                        (F.current = new Do({ handleContainerOverflow: !1 })),
                      F.current)
                    : Ho()),
                transition: zs,
      ...
      const Vs = Object.assign(_s, { Body: Rs, Header: Ms, Title: Hs }),
        Gs = s.forwardRef((e, n) => {
          let { onHide: t, ...o } = e;
          const r = (0, s.useContext)(Kn),
            a = (0, Xe.Z)(() => {
              r?.onToggle?.(), t?.();
            });
          return (0, v.jsx)(Vs, {
      ...
      Gs.displayName = "NavbarOffcanvas";
      const qs = Gs,
        Us = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "span", ...r } = e;
          return (
      ...
      const Ws = Us,
        ...
        Ys = s.forwardRef((e, n) => {
          ...
          void 0 === h.role && "nav" !== f && (h.role = "navigation");
          let N = `${y}-expand`;
          ...
          return (0, v.jsx)(Kn.Provider, {
            value: C,
            children: (0, v.jsx)(bo.Z.Provider, {
              value: j,
              children: (0, v.jsx)(f, {
                ref: n,
                ...h,
      ...
      const nr = Object.assign(er, {
        Item: at.Item,
        ItemText: at.ItemText,
        Divider: at.Divider,
        Header: at.Header,
      });
      var tr = t(74002),
        or = t(57353);
      const sr = s.forwardRef((e, n) => {
        let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
        return (
      ...
      const dr = {
        ...
        ur = s.forwardRef((e, n) => {
          ...
          let y = r;
          return (
            f && !d && (y = { ...r, ...cr(p?.strategy) }),
            (0, v.jsxs)("div", {
              ref: n,
              role: "tooltip",
              style: y,
              "x-placement": g,
              className: i()(s, b, g && `bs-popover-${h}`),
              ...m,
              children: [
                (0, v.jsx)("div", { className: "popover-arrow", ...c }),
                l ? (0, v.jsx)(ir, { children: a }) : a,
              ],
            })
          );
        });
      ur.propTypes = dr;
      const pr = Object.assign(ur, {
          Header: rr,
          Body: ir,
          POPPER_OFFSET: [0, 8],
        }),
        ...
        mr = s.forwardRef((e, n) => {
          ...
          return (
            ...
            (0, v.jsxs)("div", {
              ...
              ...f,
              children: [
                (0, v.jsx)("div", { className: "tooltip-arrow", ...l }),
                (0, v.jsx)("div", { className: `${t}-inner`, children: a }),
              ],
            })
          );
        });
      (mr.propTypes = fr), (mr.displayName = "Tooltip");
      const br = Object.assign(mr, { TOOLTIP_OFFSET: [0, 6] });
      var xr = t(63745);
      const gr = {
        container: c().oneOfType([ds.ax, c().func]),
        target: c().oneOfType([ds.ax, c().func]),
        show: c().bool,
        popperConfig: c().object,
        rootClose: c().bool,
        rootCloseEvent: c().oneOf(["click", "mousedown"]),
        onHide: c().func,
        transition: c().oneOfType([c().bool, ds.nm]),
        onEnter: c().func,
        onEntering: c().func,
        onEntered: c().func,
        onExit: c().func,
                ...
                () => ({
                  ...
                  options: {
                    offset: () => {
                      if (e) return e;
                      if (n.current) {
                        if ((0, or.Z)(n.current, t)) return pr.POPPER_OFFSET;
                        if ((0, or.Z)(n.current, o)) return br.TOOLTIP_OFFSET;
                      }
                      return [0, 0];
                    },
                  },
          ...
          (0, v.jsx)(tr.Z, {
            ...
            children: (e, n) => {
              ...
              !(function (e, n) {
                const { ref: t } = e,
                  { ref: o } = n;
                (e.ref = t.__wrapped || (t.__wrapped = (e) => t((0, xr.Z)(e)))),
                  (n.ref =
                    o.__wrapped || (o.__wrapped = (e) => o((0, xr.Z)(e))));
              })(e, a);
              const d = l?.placement,
      ...
      (hr.displayName = "Overlay"), (hr.propTypes = gr);
      const vr = hr;
      var yr = t(19874);
      function jr(e, n, t) {
        const [o] = n,
        ...
        (r && r === s) || (0, yr.Z)(s, r) || e(...n);
      }
      const Nr = c().oneOf(["click", "hover", "focus"]),
        Cr = {
          children: c().oneOfType([c().element, c().func]).isRequired,
          trigger: c().oneOfType([Nr.isRequired, c().arrayOf(Nr.isRequired)]),
          delay: c().oneOfType([
            c().number.isRequired,
            c().shape({
        ...
        Er = (e) => {
          ...
          return (
            -1 !== I.indexOf("click") && (F.onClick = R),
            -1 !== I.indexOf("focus") && ((F.onFocus = O), (F.onBlur = k)),
            -1 !== I.indexOf("hover") &&
              (Ln()(
                I.length > 1,
            ...
            (0, v.jsxs)(v.Fragment, {
              children: [
                "function" == typeof o ? o(F) : (0, s.cloneElement)(o, F),
                (0, v.jsx)(vr, {
                  ...f,
                  show: y,
                  onHide: P,
      ...
      (Pr.propTypes = Tr), (Pr.displayName = "PageItem");
      const Or = Pr;
      function kr(e, n, t) {
        void 0 === t && (t = e);
        const o = s.forwardRef((e, o) => {
          ...
          return (0, v.jsxs)(Pr, {
            ...
            ref: o,
            children: [
              (0, v.jsx)("span", { "aria-hidden": "true", children: s || n }),
              (0, v.jsx)("span", { className: "visually-hidden", children: t }),
            ],
          });
        });
        return (o.displayName = e), o;
      }
      const Rr = kr("First", "\xab"),
        Zr = kr("Prev", "\u2039", "Previous"),
        $r = kr("Ellipsis", "\u2026", "More"),
        Ir = kr("Next", "\u203a"),
        Fr = kr("Last", "\xbb"),
        Sr = { bsPrefix: c().string, size: c().oneOf(["sm", "lg"]) },
        Br = s.forwardRef((e, n) => {
      ...
      (Br.propTypes = Sr), (Br.displayName = "Pagination");
      const Mr = Object.assign(Br, {
        First: Rr,
        Prev: Zr,
        Ellipsis: $r,
        Item: Or,
      ...
      const Lr = {
        ...
        Hr = s.forwardRef((e, n) => {
          const t = Ar(e);
          return (0, v.jsx)(fe, { ...t, ref: n, disabled: !0, tabIndex: -1 });
        });
      (Hr.displayName = "PlaceholderButton"), (Hr.propTypes = Lr);
      const Dr = Hr,
        zr = {
          bsPrefix: c().string,
          animation: c().string,
        ...
        Kr = s.forwardRef((e, n) => {
          let { as: t = "span", ...o } = e;
          const s = Ar(o);
          return (0, v.jsx)(t, { ...s, ref: n });
        });
      (Kr.displayName = "Placeholder"), (Kr.propTypes = zr);
      const _r = Object.assign(Kr, { Button: Dr }),
        Vr = 1e3;
      const Gr = {
        min: c().number,
        now: c().number,
      ...
      function Ur(e, n) {
        ...
        return (0, v.jsx)("div", {
          ...
          style: { width: `${qr(o, t, s)}%`, ...u },
          "aria-valuenow": o,
          "aria-valuemin": t,
          "aria-valuemax": s,
          children: a
            ? (0, v.jsx)("span", { className: "visually-hidden", children: r })
            : r,
        });
      }
      Ur.propTypes = Gr;
      const Wr = s.forwardRef((e, n) => {
        let { isChild: t = !1, ...o } = e;
        const r = {
          min: 0,
          max: 100,
        ...
        return (0, v.jsx)("div", {
          ...
          className: i()(g, b),
          children: h
            ? rn(h, (e) => (0, s.cloneElement)(e, { isChild: !0 }))
            : Ur(
                {
                  min: a,
                  now: l,
      ...
      (Wr.displayName = "ProgressBar"), (Wr.propTypes = Gr);
      const Xr = Wr,
        Yr = {
          bsPrefix: c().string,
          children: c().element.isRequired,
      ...
      Jr.propTypes = Yr;
      const Qr = Jr,
        ea = c().oneOfType([c().number, c().string]),
        na = c().oneOfType([ea, c().shape({ cols: ea })]),
        ta = {
          bsPrefix: c().string,
          as: c().elementType,
          xs: na,
        ...
        oa = s.forwardRef((e, n) => {
          ...
          return (
            ...
            (0, v.jsx)(s, { ref: n, ...r, className: i()(o, a, ...p) })
          );
        });
      (oa.displayName = "Row"), (oa.propTypes = ta);
      const sa = oa,
        ra = {
          bsPrefix: c().string,
          variant: c().string,
      ...
      (aa.propTypes = ra), (aa.displayName = "Spinner");
      const ia = aa,
        la = {
          id: c().string,
      ...
      (ca.propTypes = la), (ca.displayName = "SplitButton");
      const da = ca;
      const ua = t(20347).HK;
      function pa(e, n, t) {
      ...
      const fa = {
        ...
        gap:
          ...
          c().oneOfType([
            ma,
            c().shape({ xs: ma, sm: ma, md: ma, lg: ma, xl: ma, xxl: ma }),
          ])),
      };
      var ma;
      const ba = s.forwardRef((e, n) => {
        let {
          as: t = "div",
          bsPrefix: o,
          className: s,
        ...
        return (0, v.jsx)(t, {
          ...l,
          ref: n,
          className: i()(s, o, ...pa({ gap: a }, c, d)),
        });
      });
      (ba.displayName = "Stack"), (ba.propTypes = fa);
      const xa = ba;
      var ga = t(94836),
        ha = t(12409);
      function va(e) {
        return "boolean" == typeof e ? (e ? dt.Z : ha.Z) : e;
      }
      const ya = {
          id: c().string,
        ...
        ja = (e) => {
          ...
          return (0, v.jsx)(ga.Z, { ...t, transition: va(n) });
        };
      (ja.propTypes = ya), (ja.displayName = "TabContainer");
      const Na = ja,
        Ca = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
          return (
      ...
      const Pa = {
        ...
        Oa = s.forwardRef((e, n) => {
          ...
          const [
            ...
            ] = (0, Ta.W)({ ...s, transition: va(o) }),
            j = (0, u.vE)(t, "tab-pane");
          return (0, v.jsx)(wa.Z.Provider, {
            value: null,
            children: (0, v.jsx)(bo.Z.Provider, {
              value: null,
              children: (0, v.jsx)(y, {
      ...
      (Oa.displayName = "TabPane"), (Oa.propTypes = Pa);
      const ka = Oa,
        Ra = {
          eventKey: c().oneOfType([c().string, c().number]),
          title: c().node.isRequired,
      ...
      Za.propTypes = Ra;
      const $a = Object.assign(Za, { Container: Na, Content: Ea, Pane: ka });
      var Ia = t(89542);
      const Fa = {
        activeKey: c().oneOfType([c().string, c().number]),
        defaultActiveKey: c().oneOfType([c().string, c().number]),
      ...
      (Ma.propTypes = Fa), (Ma.displayName = "Tabs");
      const Aa = Ma,
        La = { [f.d0]: "showing", [f.Ix]: "showing show" },
        Ha = s.forwardRef((e, n) =>
          (0, v.jsx)(dt.Z, { ...e, ref: n, transitionClasses: La })
        );
      Ha.displayName = "ToastFade";
      const Da = Ha,
        za = s.createContext({ onClose() {} }),
        Ka = {
          bsPrefix: c().string,
          closeLabel: c().string,
          closeVariant: c().oneOf(["white"]),
      ...
      (_a.displayName = "ToastHeader"), (_a.propTypes = Ka);
      const Va = _a,
        Ga = s.forwardRef((e, n) => {
          let { className: t, bsPrefix: o, as: s = "div", ...r } = e;
          return (
      ...
      (Wa.propTypes = Ua), (Wa.displayName = "Toast");
      const Xa = Object.assign(Wa, { Body: qa, Header: Va }),
        Ya = {
          bsPrefix: c().string,
          position: c().oneOf([
            "top-start",
        ...
        Qa = s.forwardRef((e, n) => {
          ...
          return (
            ...
            (0, v.jsx)(a, {
              ref: n,
              ...l,
              className: i()(t, o && Ja[o], s && `position-${s}`, r),
            })
          );
        });
      (Qa.displayName = "ToastContainer"), (Qa.propTypes = Ya);
      const ei = Qa,
        ni = () => {},
        ti = {
          bsPrefix: c().string,
      ...
      (oi.propTypes = ti), (oi.displayName = "ToggleButton");
      const si = oi,
        ri = {
          name: c().string,
          value: c().any,
      ...
      ai.propTypes = ri;
      const ii = Object.assign(ai, { Button: si });
      var li = t(82175),
        ci = t(16310);
      const di = (e) => {
        ...
        return (0, v.jsxs)("svg", {
          ...
          focusable: "false",
          children: [
            (0, v.jsx)("title", { children: n }),
            (0, v.jsx)("rect", { width: "100%", height: "100%", fill: "#555" }),
            (0, v.jsx)("text", {
              x: "50%",
              y: "50%",
              fill: "#333",
      ...
      di.displayName = "ExampleCarouselImage";
      const ui = di,
        pi = {
          React: r,
          ...r,
