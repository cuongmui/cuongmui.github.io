/*! For license information please see 1a4e3797.759dd907.js.LICENSE.txt */
(self.webpackChunkreact_bootstrap_website =
  ...
  [7920],
  {
    ...
    8131: (e, t, r) => {
      ...
      (a.version = r(24336)),
        (a.AlgoliaSearchHelper = n),
        (a.SearchParameters = i),
        (a.SearchResults = s),
        (e.exports = a);
    },
    68078: (e, t, r) => {
      ...
      function v(e, t, r) {
        ...
        Object.keys(R).forEach(function (t) {
          ...
          if (o) {
            ...
            m &&
              ((l = g[t]),
              (u.disjunctiveFacets[l] = {
                name: t,
                data: i,
                exhaustive: s.exhaustiveFacetsCount,
              }),
              p(u.disjunctiveFacets[l], s.facets_stats, t)),
              d &&
                ((l = v[t]),
                (u.facets[l] = {
                  name: t,
          ...
          f.forEach(function (r) {
            ...
            Object.keys(a).forEach(function (t) {
              ...
              if (h) {
                ...
                if (-1 === m) return;
                u.hierarchicalFacets[r][m].data = o(
                  {},
                  u.hierarchicalFacets[r][m].data,
                  f
                );
              } else {
                r = g[t];
              ...
              t.slice(y).forEach(function (t) {
                ...
                Object.keys(r).forEach(function (t) {
                  ...
                  if (-1 !== f) {
                    ...
                    u.hierarchicalFacets[h][f].data = i(
                      l,
                      o,
                      u.hierarchicalFacets[h][f].data
                    );
                  }
                }),
                  y++;
        ...
        (d.prototype.findAnswers = function (e) {
          ...
          var n = r.getModifiedState(t),
            i = c(
              ...
              {
                params: o(h._getHitsSearchParams(n), [
                  "attributesToSnippet",
                  "hitsPerPage",
          ...
          return (
            i
              ...
              : (delete o.facetName,
                (f = this.client
                  .search([
                    { type: "facet", facet: e, indexName: c.index, params: o },
                  ])
                  .then(function (e) {
                    return e.results[0];
                  }))),
          ...
          if (!(t < this._lastQueryIdReceived)) {
            ...
            e.forEach(function (e) {
              var t = e.state,
                ...
                a = i.splice(0, r);
              t.index
                ? ((s.lastResults = new l(t, a, n._searchResultsOptions)),
    ...
    96394: (e, t, r) => {
      ...
      var s = {
                ...
                if (void 0 !== s) {
                  ...
                  if (t === i) {
                    if (
                      ...
                      return;
                    f
                      ? ((u = f.split(h).length - 1), (s = f))
                      : ((u = s.split(h).length - 2),
        ...
        getSearchForFacetQuery: function (e, t, r, a) {
          ...
          return (
            "number" == typeof r && (u.maxFacetHits = r),
            i(n({}, s._getHitsSearchParams(c), u))
          );
        },
      };
      e.exports = s;
          ...
          var a = [],
            ...
            m = function t(r, s) {
              ...
              var m = {
                  ...
                  method: o,
                  url: _(h, n.path, f),
                  connectTimeout: s(l, e.timeouts.connect),
                  responseTimeout: s(l, i.timeout),
                },
                d = function (e) {
                  var t = {
                    request: m,
                  ...
                  onRetry: function (n) {
                    ...
                    return (
                      ...
                      Promise.all([
                        ...
                        e.hostsCache.set(h, y(h, n.isTimedOut ? g : v)),
                      ]).then(function () {
                        return t(r, s);
                      })
                    );
            ...
            return function (t, i) {
              return Promise.all(
                t.map(function (t) {
                  ...
                  }).searchForFacetValues(a, c, r(r({}, i), u));
                })
              );
            };
          },
        ...
        function V(e, t, n) {
          var i,
            s = {
              ...
              hostsCache: c({
                caches: [a({ key: "".concat("4.22.0", "-").concat(e) }), u()],
              }),
              userAgent: x("4.22.0").add({
                segment: "Browser",
                version: "lite",
              }),
    ...
    56434: (e, t, r) => {
      ...
      var a = r(8131),
        ...
        m = r(94104),
        d = r(52263);
      const p = ["zero", "one", "two", "few", "many", "other"];
      function v(e) {
        return p.filter((t) => e.includes(t));
      }
      const g = {
        locale: "en",
        pluralForms: v(["one", "other"]),
        ...
        return (0, n.useMemo)(() => {
          try {
            return (function (e) {
              ...
              return {
                locale: e,
                pluralForms: v(t.resolvedOptions().pluralCategories),
                select: (e) => t.select(e),
              };
            })(e);
          } catch (t) {
        ...
        return (0, N.jsx)("div", {
          ...
          children: r.map((e) => {
            ...
            return (0, N.jsx)(
              "select",
              {
                onChange: (e) => t.setSearchVersion(n, e.target.value),
                defaultValue: t.searchVersions[n],
                className: A.searchVersionInput,
      ...
      function S() {
        const {
          ...
          {
            algolia: { appId: t, apiKey: r, indexName: i, contextualSearch: a },
          } = (0, _.L)(),
          u = (0, E.l)(),
          p = (function () {
            const { selectMessage: e } = R();
            return (t) =>
              e(
                t,
                (0, x.I)(
        ...
        I.on("result", (e) => {
          ...
          if ("" === t || !Array.isArray(r)) return void T({ type: "reset" });
          const a = (e) =>
              e.replace(
            ...
            c = r.map((e) => {
              ...
              return {
                title: i.pop(),
                url: u(t),
                summary: n.content ? `${a(n.content.value)}...` : "",
                breadcrumbs: i,
              };
            });
          T({
        ...
        const [D, k] = (0, n.useState)(null),
          q = (0, n.useRef)(0),
          V = (0, n.useRef)(
            h.Z.canUseIntersectionObserver &&
              new IntersectionObserver(
                (e) => {
                  ...
                  t && q.current > r && T({ type: "advance" }), (q.current = r);
                },
                { threshold: 1 }
              )
          ),
          ...
          B = (0, b.zX)(function (t) {
            void 0 === t && (t = 0),
              a &&
                (I.addDisjunctiveFacetRefinement("docusaurus_tag", "default"),
                I.addDisjunctiveFacetRefinement("language", e),
                Object.entries(v.searchVersions).forEach((e) => {
                  let [t, r] = e;
              ...
              I.setQuery(g).setPage(t).search();
          });
        return (
          (0, n.useEffect)(() => {
            if (!D) return;
            const e = V.current;
            return e ? (e.observe(D), () => e.unobserve(D)) : () => !0;
          }, [D]),
          (0, n.useEffect)(() => {
            T({ type: "reset" }),
              g &&
          ...
          }, [g, v.searchVersions, B]),
          (0, n.useEffect)(() => {
            S.lastPage && 0 !== S.lastPage && B(S.lastPage);
          }, [B, S.lastPage]),
          (0, N.jsxs)(O.Z, {
            children: [
              (0, N.jsxs)(f.Z, {
                children: [
                  (0, N.jsx)("title", { children: (0, P.p)(L()) }),
                  (0, N.jsx)("meta", {
                    property: "robots",
              ...
              (0, N.jsxs)("div", {
                ...
                children: [
                  (0, N.jsx)(w.Z, { as: "h1", children: L() }),
                  (0, N.jsxs)("form", {
                    className: "row",
                    onSubmit: (e) => e.preventDefault(),
                    children: [
                      (0, N.jsx)("div", {
                        className: s("col", A.searchQueryColumn, {
                          "col--9": v.versioningEnabled,
                          "col--12": !v.versioningEnabled,
                        }),
                        children: (0, N.jsx)("input", {
                          type: "search",
                          name: "q",
                          className: A.searchQueryInput,
                          placeholder: (0, x.I)({
                      ...
                      a &&
                        v.versioningEnabled &&
                        (0, N.jsx)(H, { docsSearchVersionsHelpers: v }),
                    ],
                  }),
                  (0, N.jsxs)("div", {
                    className: "row",
                    children: [
                      (0, N.jsx)("div", {
                        className: s("col", "col--8", A.searchResultsColumn),
                        children: !!S.totalResults && p(S.totalResults),
                      }),
                      (0, N.jsx)("div", {
                        className: s(
                          "col",
                        ...
                        children: (0, N.jsx)(l.Z, {
                          ...
                          children: (0, N.jsx)("svg", {
                            viewBox: "0 0 168 24",
                            className: A.algoliaLogo,
                            children: (0, N.jsxs)("g", {
                              fill: "none",
                              children: [
                                (0, N.jsx)("path", {
                                  className: A.algoliaLogoPathFill,
                    ...
                    ? (0, N.jsx)("main", {
                        children: S.items.map((e, t) => {
                          ...
                          return (0, N.jsxs)(
                            "article",
                            {
                              className: A.searchResultItem,
                              children: [
                                (0, N.jsx)(w.Z, {
                                  as: "h2",
                                  className: A.searchResultItemHeading,
                                  children: (0, N.jsx)(l.Z, {
                                    to: n,
                                ...
                                i &&
                                  (0, N.jsx)("p", {
                                    className: A.searchResultItemSummary,
