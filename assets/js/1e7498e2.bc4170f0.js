  ...
  [8113],
  {
    53513: (e, n, t) => {
      ...
      const s =
        ...
        l = void 0,
        c = {
          id: "components/images",
          title: "Images",
          description:
            "Documentation and examples for opting images into responsive behavior (so they never become wider than their parent) and add lightweight styles to them\u2014all via classes.",
          source: "@site/docs/components/images.mdx",
          sourceDirName: "components",
          slug: "/components/images",
          permalink: "/docs/components/images",
          draft: !1,
          unlisted: !1,
          tags: [],
          version: "current",
          ...
          sidebar: "sidebar",
          previous: { title: "Figures", permalink: "/docs/components/figures" },
          next: {
            title: "List groups",
      ...
      function p(e) {
        const n = {
          ...
          { CodeBlock: t, PropsTable: a } = n;
        return (
          t || u("CodeBlock", !0),
          a || u("PropsTable", !0),
          (0, o.jsxs)(o.Fragment, {
            children: [
              (0, o.jsx)(n.h2, { id: "shape", children: "Shape" }),
              "\n",
              (0, o.jsxs)(n.p, {
                children: [
                  "Use the ",
                  (0, o.jsx)(n.code, { children: "rounded" }),
                  ", ",
                  (0, o.jsx)(n.code, { children: "roundedCircle" }),
                  " and ",
                  (0, o.jsx)(n.code, { children: "thumbnail" }),
                  " props to customise\nthe image.",
                ],
              }),
              "\n",
